...
[`@aws-sdk/client-bedrock-agentcore`](https://www.npmjs.com/package/@aws-sdk/client-bedrock-agentcore/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agentcore@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TbaZK48TivKPAsv18o+GMHts5siPukSdtOemAqofYWXXkWL5mDBFrdTxXSIfadnR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bedrock-agentcore": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agentcore@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agentcore@3.994.0/index.min.mjs": "sha384-TbaZK48TivKPAsv18o+GMHts5siPukSdtOemAqofYWXXkWL5mDBFrdTxXSIfadnR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-bedrock-agentcore/blob/refs/tags/3.994.0/LICENSE
```
